...
### Update Task Content
```bash
neoDo -u 1 "Buy milk and bread"
```

### Delete a Task
```bash
neoDo -d 3  # Deletes task with ID 3
```
...
- Project inspired by [roadmap.sh](https://roadmap.sh)
- Built with pure C and standard libraries
